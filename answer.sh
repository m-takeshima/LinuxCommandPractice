...
$ touch ./practice_dir_1/practice_dir_2/{practice_file_1.txt,practice_file2.txt}
...
# 14. `practice_file1.txt`を一つ上の階層のディレクトリ(`LinuxCommandPractice`)へ**移動**してください。**但し、相対パスを使用してください。**
一つ上の階層はpractice_dir_1。LinuxCommandPracticeは２つ上の階層。
$ mv practice_file1.txt ../../ もしくは　mv practice_file1.txt ../../../LinuxCommandPractice


# 15. `practice_file2.txt`を一つ上の階層のディレクトリ(`LinuxCommandPractice`)へ**コピー**してください。**但し、相対パスを使用してください。**
一つ上の階層はpractice_dir_1。LinuxCommandPracticeは２つ上の階層。
...
I'm good at Linux commands!と入力
